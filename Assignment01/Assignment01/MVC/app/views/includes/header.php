   ...
   <?php
    if (isLoggedIn()) { 
      echo '<div class="collapse navbar-collapse" id="navbarNavDarkDropdown">
          <ul class="navbar-nav">
              <li class="nav-item dropdown">
                  <a class="nav-link dropdown-toggle" id="navbarDarkDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">My Videos</a>
                  <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="navbarDarkDropdownMenuLink">
                    <li><a class="dropdown-item" href="/MVC/Video/getVideos">View Videos</a></li>
                    <li><a class="dropdown-item" href="/MVC/Video/createVideo">Upload Video</a></li>
                  </ul>
                </li>
          </ul>
      </div>';
      ...
      echo '<li class="nav-item">
          <a class="nav-link" href="/MVC/Login">My Videos</a>
        </li>';
    }
  ?>
